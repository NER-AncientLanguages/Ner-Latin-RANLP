...
import wandb
#I originally wanted to do it like this so it logs to the correct project, unfortunately it returns a 'brokenpipeerror'
wandb.login(relogin=True)

# user = "myke-beersmans"
# project = "Latin_NER"
# display_name = "experiment-with-hypopt-2023-05-25"

# wandb.init(project=project, entity=user)
